...
The following schemas are used in Verity's implementation.
...
Verity's intial release contains only the USA KYC/AML process definition ("https://verite.id/schemas/definitions/1.0.0/kycaml/usa",). Additional process defnitions will be developed based on existing practices/requirements per country.
...
[See further discussion of registry forensics flows](/docs/patterns/smart-contract-verity#auditing-and-forensics-sequences)
